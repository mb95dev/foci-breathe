...
```plain
   ...
   spec_base_path: .cursor/specs
   documents: .cursor/specs/test-feature/requirements_v5.md,
              .cursor/specs/test-feature/requirements_v6.md,
              .cursor/specs/test-feature/requirements_v7.md,
              .cursor/specs/test-feature/requirements_v8.md
```
...
- Generate final_document_path with a random 4-digit suffix (e.g., `.cursor/specs/test-feature/requirements_v1234.md`)
